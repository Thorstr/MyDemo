...
extern uint8_t usart3_temp_buffer[1];
...
extern void UsartDefaultTask(void *argument);
extern void LedDefaultTask(void *argument);
/* USER CODE END 0 */
...
int main(void)
{
  ...
  usartTaskHandle = osThreadNew(UsartDefaultTask, NULL, &usartTask_attributes);
